...
{
	std::shared_ptr<GDX12DescriptorHeap> SRV_UAV_Heap = nullptr;
	std::shared_ptr<GDX12DescriptorHeap> RTVHeap = nullptr;
	std::shared_ptr<GDX12DescriptorHeap> DSVHeap = nullptr;
	UINT Width = 0;
	UINT Height = 0;
...
public:
	...
	//This will wipe all data on said resources
