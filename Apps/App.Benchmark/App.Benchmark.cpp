...
#include <Engine.Core/MathHelper.h>
#include <Engine.Core/GeometryGenerator.h>

#include <Engine.RendererDX12/d3dApp.h>
#include <Engine.RendererDX12/UploadBuffer.h>
#include <Engine.RendererDX12/FrameResource.h>
...
void StencilApp::OnKeyboardInput(const GameTimer& gt)
{
	...
	XMMATRIX skullRotate = XMMatrixRotationY(0.5f * DirectX::XM_PI);
...
void StencilApp::LoadTextures()
{
	...
	bricksTex->Filename = ASSETS_FOLDER L"Textures/bricks3.dds";
	...
	checkboardTex->Filename = ASSETS_FOLDER L"Textures/checkboard.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
	...
	iceTex->Name = "iceTex";
	iceTex->Filename = ASSETS_FOLDER L"Textures/ice.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
	...
	white1x1Tex->Filename = TEXTURES_FOLDER L"white1x1.dds";
	ThrowIfFailed(DirectX::CreateDDSTextureFromFile12(md3dDevice.Get(),
...
void StencilApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(SHADERS_FOLDER L"Default.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(SHADERS_FOLDER L"Default.hlsl", defines, "PS", "ps_5_0");
	mShaders["alphaTestedPS"] = d3dUtil::CompileShader(SHADERS_FOLDER L"Default.hlsl", alphaTestDefines, "PS", "ps_5_0");
...
{
	std::ifstream fin(MODELS_FOLDER "skull.txt");
